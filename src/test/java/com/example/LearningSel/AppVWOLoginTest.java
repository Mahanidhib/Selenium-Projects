...
public class AppVWOLoginTest {
	...
	public void invalidLogin() throws InterruptedException  {
		...
		driver.findElement(By.id("login-username")).sendKeys("mahanidhi125@gmail.com");
		driver.findElement(By.name("password")).sendKeys("Mahanidhi@");
	...
	public void validLogin()  {
		...
		driver.get("https://app.vwo.com/#/login");
		driver.findElement(By.id("login-username")).sendKeys("mahanidhi125@gmail.com");
		driver.findElement(By.name("password")).sendKeys("Mahanidhi@97");
		driver.findElement(By.id("js-login-btn")).click();
